...
1. `app/service_api.py` receives a question.
2. `app/api_llm.py` builds runtime artifacts:
   - question classification
   - keyword extraction
   - optional NL2SQL generation
3. `app/financial_agent_workflow.py` builds a route-aware `QuestionContext`.
...
- a deliberately trimmed structured data subset
